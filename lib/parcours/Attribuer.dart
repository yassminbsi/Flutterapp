  ...
  for (int i = 0; i < stations.length; i++) {
    ...
    if (i < stations.length - 1) {
      ...
      if (currentStationSnapshot.exists && nextStationSnapshot.exists) {
        ...
        var response = await http.get(
          Uri.parse('https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=$currentLat,$currentLng&destinations=$nextLat,$nextLng&key=AIzaSyDI1prEDeGy0UImJM0ZDPikd0lYZOEp6PQ'),
        );
